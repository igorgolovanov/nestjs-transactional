...
export class SyncVoidHandler implements ITransactionalEventHandler<OrderPlacedEvent> {
...
export class CrossModuleHandler implements IIntegrationEventHandler<OrderPlacedEvent> {
